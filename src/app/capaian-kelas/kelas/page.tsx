...
export default function Page() {
  ...
  return (
    <Container>
      ...
      >
        <h3 style={{ marginBottom: "15px", color: "black" }}>Capaian Kelas </h3>
        <p style={{ marginBottom: "15px", color: "black" }}>Tryout XXX</p>
        <CircleWithInner background={"#78CF93"} width={100} height={100} label={"100"} />
        <p style={{ margin: "15px 0px", color: "black" }}>Skor Tertinggi</p>
        <div
          style={{
            display: "flex",
            flexDirection: "column",
